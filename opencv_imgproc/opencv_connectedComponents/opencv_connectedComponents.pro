...
TARGET = opencv_connectedComponents
CONFIG += console
...
SOURCES += opencv_connectedComponents_run.cpp
...
DISTFILES += $$PWD/private/opencv_connectedComponents_run_exception.cpp
...
DISTFILES += $$PWD/opencv_connectedComponents.lua
