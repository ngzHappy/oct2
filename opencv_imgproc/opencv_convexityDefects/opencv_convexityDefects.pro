...
TARGET = opencv_convexityDefects
CONFIG += console
...
SOURCES += opencv_convexityDefects_run.cpp
...
DISTFILES += $$PWD/private/opencv_convexityDefects_run_exception.cpp
...
DISTFILES += $$PWD/opencv_convexityDefects.lua
