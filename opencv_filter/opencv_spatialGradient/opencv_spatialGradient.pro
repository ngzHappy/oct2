...
SOURCES += opencv_spatialGradient_run.cpp
...
DISTFILES += $$PWD/private/opencv_spatialGradient_run_exception.cpp
...
DISTFILES += $$PWD/opencv_spatialGradient.lua
