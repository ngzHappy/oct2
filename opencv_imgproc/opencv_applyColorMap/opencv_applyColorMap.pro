...
SOURCES += opencv_applyColorMap_run.cpp
...
DISTFILES += $$PWD/private/opencv_applyColorMap_run_exception.cpp
...
DISTFILES += $$PWD/opencv_applyColorMap.lua
