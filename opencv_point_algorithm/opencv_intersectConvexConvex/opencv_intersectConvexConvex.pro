...
TARGET = opencv_intersectConvexConvex
CONFIG += console
...
SOURCES += opencv_intersectConvexConvex_run.cpp
...
DISTFILES += $$PWD/private/opencv_intersectConvexConvex_run_exception.cpp
...
DISTFILES += $$PWD/opencv_intersectConvexConvex.lua
