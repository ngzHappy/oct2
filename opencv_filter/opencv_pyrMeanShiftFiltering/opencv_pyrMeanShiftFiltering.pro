...
TARGET = opencv_pyrMeanShiftFiltering
CONFIG += console
...
SOURCES += opencv_pyrMeanShiftFiltering_run.cpp
...
DISTFILES += $$PWD/private/opencv_pyrMeanShiftFiltering_run_exception.cpp
...
DISTFILES += $$PWD/opencv_pyrMeanShiftFiltering.lua
