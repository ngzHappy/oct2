...
TARGET = opencv_pointPolygonTest
CONFIG += console
...
SOURCES += opencv_pointPolygonTest_run.cpp
...
DISTFILES += $$PWD/private/opencv_pointPolygonTest_run_exception.cpp
...
DISTFILES += $$PWD/opencv_pointPolygonTest.lua
